...
- 이번 실험에서는 2m 길이의 파이프에 25cm 간격으로 센서를 배치하고, 낙하하는 물체가 센서를 지날때마다 시간을 기록할 것이다. 변위와 시간을 측정할 수 있으므로 초기속도({{</* katex */>}}v_0{{</* /katex */>}})값만 알면 ⑥을 이용하여 중력 가속도를 계산할 수 있다.
...
![](/image/Gravitational-Acceleration01.png)
...
![](/image/Gravitational-Acceleration03.png)
...
![](/image/Gravitational-Acceleration07.jpg)
...
![](/image/Gravitational-Acceleration09.png)
